...
class AccessAttemptTest(DefenderTestCase):
    ...
    @patch('account_defender.config.USERNAME_FAILURE_LIMIT', 3)
    ...
    @patch('account_defender.config.LOCKOUT_URL', '/o/login/')
    ...
    @patch('account_defender.config.LOCKOUT_TEMPLATE', 'defender/lockout.html')
    ...
    @patch('account_defender.config.COOLOFF_TIME', 0)
    ...
    @patch('account_defender.config.DEFENDER_REDIS_NAME', 'default')
    def test_get_redis_connection_django_conf(self):
        """ get the redis connection """
        redis_client = get_redis_connection()
        self.assertIsInstance(redis_client, Redis)

    @patch('account_defender.config.DEFENDER_REDIS_NAME', 'bad-key')
    ...
    @patch('account_defender.config.BEHIND_REVERSE_PROXY', True)
    @patch('account_defender.config.REVERSE_PROXY_HEADER', 'HTTP_X_PROXIED')
    ...
    @patch('account_defender.config.BEHIND_REVERSE_PROXY', True)
    @patch('account_defender.config.REVERSE_PROXY_HEADER', 'HTTP_X_REAL_IP')
    ...
    @patch('account_defender.config.USE_CELERY', True)
    ...
    @patch('account_defender.config.LOCKOUT_BY_IP_USERNAME', True)
    ...
    @patch('account_defender.config.DISABLE_IP_LOCKOUT', True)
    ...
    @patch('account_defender.config.DISABLE_USERNAME_LOCKOUT', True)
