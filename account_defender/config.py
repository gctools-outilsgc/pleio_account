...
USERNAME_FAILURE_LIMIT = \
    get_setting('DEFENDER_LOGIN_FAILURE_LIMIT_USERNAME', FAILURE_LIMIT)
IP_FAILURE_LIMIT = \
    get_setting('DEFENDER_LOGIN_FAILURE_LIMIT_IP', FAILURE_LIMIT)
...
GET_USERNAME_FROM_REQUEST_PATH = get_setting(
    ...
    'account_defender.utils.username_from_request'
)
