...
MIDDLEWARE_CLASSES = (
    ...
    'account_defender.middleware.FailedLoginMiddleware',
)

ROOT_URLCONF = 'account_defender.test_urls'
...
os.environ.setdefault('DJANGO_SETTINGS_MODULE', 'account_defender.test_settings')
