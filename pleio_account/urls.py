...
urls = [
    ...
    url(r'^security-questions/$', views.set_security_question, name='set-questions'),
    ...
    url(r'^password_reset/questions/$', views.security_questions, name='password_reset_questions'),
