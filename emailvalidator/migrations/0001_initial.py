    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('allow_all', models.BooleanField(default=False, verbose_name='Allow all from domain'))
            ],
        ),
        migrations.RunSQL(
        ...
        migrations.RunSQL(
          [('INSERT INTO emailvalidator_emailregexvalidator (regex, group_id, name, allow_all) values (%s, 1, %s, False)', ['.*', 'Any'])]
        ),
    ]
